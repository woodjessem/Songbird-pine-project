...
##  For Community Ecology 2016                                                              ##
##############################################################################################

#First set the working director where your data are stored and where you want the output to go
setwd("C:\\Users\\woodj\\Documents\\GRAD SCHOOL - CLEMSON\\Classes\\Community Ecology\\DATA_ANALYSIS")
...
D<-read.csv(file="pcdata.csv") #Jesse data on point counts version from 09-12 manipulating
...
write.table(file="Diversity and Richness Estimates.csv",sep=",",col.names=NA, DivNums)
...
colors<-c("red","blue","green","black") #Specify a vector of colors
                          #Add more colors to this list as needed/Change as needed
SiteNames<-c("Bunched_Arrowhead_Preserve","Blue_Wall_Preserve","Lake_Conestee_Nature_Park","Sweetwater_Easement") #Specify your site names
