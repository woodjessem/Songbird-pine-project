...
figx + labs(x= "Burn treatment * Survey year", y="Species Richness") + set_theme(title.color = "white") + xlim(c("0B","1B","2B","3B")) + coord_cartesian(ylim=c(18,36)) + scale_y_continuous(breaks=seq(18, 36, 6))
