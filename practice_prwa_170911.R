...
lh2.prwa <- pcount(~ Jdate + Noise ~ Age + TimeSinceB + BA, prwa.abund, mixture="NB", K=15)
...
lh3.prwa <- pcount(~ Jdate + Wind + Sky + Noise ~ Age + TimeSinceB + BA, prwa.abund, mixture="NB", K=15)
...
fms4 <- fitList(null3.prwa, global3.prwa, local3.prwa, lh3.prwa, treatment3.prwa, disturbance3.prwa)
ms4.prwa <- modSel(fms4)
ms4.prwa

#ms4: null best, life history second best but @3.27.
