...
```{r}
Nmix.gof.test(landmetrics.cavity, nsim = 50, plot.hist = TRUE, report = NULL) #increase nsim
#?Nmix.gof.test()
Nmix.chisq(siteprod.cavity)
```

```{r}
fitstats <- function(landmetrics.cavity) {
  observed <- getY(landmetrics.cavity@data)
  expected <- fitted(landmetrics.cavity)
  resids <- residuals(landmetrics.cavity)
...
pb <- parboot(landmetrics.cavity, fitstats, nsim=25, report=1)
plot(pb, main="")
```
...
Nmix.gof.test(landmetrics.tree, nsim = 50, plot.hist = TRUE, report = TRUE) #increase nsim
#?Nmix.gof.test()
...
```{r}
#put species' top model in place of "landscape5.prwa" & up nsim
Nmix.gof.test(landscape1.ground, nsim = 50, plot.hist = TRUE, report = NULL) #increase nsim
#?Nmix.gof.test()
Nmix.chisq(greenberg.shrub)
```
...
```{r}
#put species' top model in place of "landscape5.prwa" & up nsim
Nmix.gof.test(coord.bf, nsim = 50, plot.hist = TRUE, report = NULL) #increase nsim
#?Nmix.gof.test()
Nmix.chisq(null.bf)
```
...
```{r}
#put species' top model in place of "landscape5.prwa" & up nsim
Nmix.gof.test(landscape1.fg, nsim = 50, plot.hist = TRUE, report = NULL) #increase nsim
#?Nmix.gof.test()
...
```{r}
#put species' top model in place of "landscape5.prwa" & up nsim
Nmix.gof.test(landscape500.fg, nsim = 50, plot.hist = TRUE, report = NULL) #increase nsim
#?Nmix.gof.test()
...
```{r}
#put species' top model in place of "landscape5.prwa" & up nsim
Nmix.gof.test(local.gf, nsim = 50, plot.hist = TRUE, report = NULL) #increase nsim
#?Nmix.gof.test()
Nmix.chisq(local.gf)
```
