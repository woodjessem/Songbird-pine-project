...
Nmix.gof.test(treatment.bhnu, nsim = 25, plot.hist = TRUE, report = NULL) #increase nsim
#?Nmix.gof.test()
Nmix.chisq(treatment.bhnu)
```

```{r, echo=FALSE}
Nmix.gof.test(lh.bhnu, nsim = 25, plot.hist = TRUE, report = NULL) #increase nsim
#?Nmix.gof.test()
Nmix.chisq(lh.bhnu)
```
...
```{r, echo=FALSE}
#put species' top model in place of "landscape5.prwa" & up nsim
Nmix.gof.test(upstate.cawr, nsim = 25, plot.hist = TRUE, report = NULL) #increase nsim
#?Nmix.gof.test()
...
```{r, echo=FALSE}
#put species' top model in place of "landscape5.prwa" & up nsim
Nmix.gof.test(Nsiteprod.cach, nsim = 25, plot.hist = TRUE, report = NULL) #increase nsim
#?Nmix.gof.test()
Nmix.chisq(Nsiteprod.cach)
```
...
```{r, echo=FALSE}
Nmix.gof.test(lh.eabl, nsim = 25, plot.hist = TRUE, report = NULL) #increase nsim
#?Nmix.gof.test()
Nmix.chisq(lh.eabl)
```
...
```{r, echo=FALSE}
Nmix.gof.test(treatment.eawp, nsim = 25, plot.hist = TRUE, report = NULL) #increase nsim
#?Nmix.gof.test()
Nmix.chisq(treatment.eawp)
```

```{r, echo=FALSE}
Nmix.gof.test(disturbance.eawp, nsim = 25, plot.hist = TRUE, report = NULL) #increase nsim
#?Nmix.gof.test()
Nmix.chisq(disturbance.eawp)
```
...
```{r, echo=FALSE}
Nmix.gof.test(local.inbu, nsim = 25, plot.hist = TRUE, report = NULL) #increase nsim
#?Nmix.gof.test()
...
```{r, echo=FALSE}
Nmix.gof.test(landscape1.nobo, nsim = 25, plot.hist = TRUE, report = NULL) #increase nsim
#?Nmix.gof.test()
...
```{r, echo=FALSE}
Nmix.gof.test(coord.piwa, nsim = 25, plot.hist = TRUE, report = NULL) #increase nsim
#?Nmix.gof.test()
Nmix.chisq(coord.piwa)
```

```{r, echo=FALSE}
Nmix.gof.test(landscape30.piwa, nsim = 25, plot.hist = TRUE, report = NULL) #increase nsim
#?Nmix.gof.test()
Nmix.chisq(landscape30.piwa)
```

```{r, echo=FALSE}
Nmix.gof.test(landscape5.piwa, nsim = 25, plot.hist = TRUE, report = NULL) #increase nsim
#?Nmix.gof.test()
Nmix.chisq(landscape5.piwa)
```
...
```{r, echo=FALSE}
Nmix.gof.test(landscape1.prwa, nsim = 25, plot.hist = TRUE, report = NULL) #increase nsim
#?Nmix.gof.test()
...
```{r, echo=FALSE}
Nmix.gof.test(coord.rbwo, nsim = 25, plot.hist = TRUE, report = NULL) #increase nsim
#?Nmix.gof.test()
...
```{r, echo=FALSE}
Nmix.gof.test(landscape1.ybch, nsim = 25, plot.hist = TRUE, report = NULL) #increase nsim
